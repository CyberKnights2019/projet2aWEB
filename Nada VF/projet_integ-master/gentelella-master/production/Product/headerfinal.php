...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            <li><a href="<?php echo $environment; ?>/projet_integ-master/gentelella-master/production/AdminNada/afficherClient.php"><i class="fa fa-laptop"></i> Clients' List  </a></li>
            <li><a href="<?php echo $environment; ?>/projet_integ-master/gentelella-master/production/AdminNada/afficherAdmin.php"><i class="fa fa-laptop"></i> Admins' List  </a></li>
            <li>
                <a><i class="fa fa-table"></i> Commande <span class="fa fa-chevron-down"></span></a>

                <ul class="nav child_menu">

                    <li><a href="<?php echo $environment; ?>/projet_integ-master/gentelella-master/production/tables_dynamic.php">Liste De Commande</a></li>
