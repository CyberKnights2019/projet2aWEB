            ...
            <div class="col-md-6">
                ...
                <p><strong>
                    <?php foreach ($sth1 as $row) {}?>
                                        ...
                                        {?>
                                         <p class="text-primary h4"><strike><?php echo $p['prix']; ?>DT</strike><?php echo "  -".$row['tauxReduction']."%" ?></p>
                                         <p class="text-primary h4"><?php echo $p['prix']-($p['prix']*$row['tauxReduction'])/100; ?>DT</p>

                                        <?php }else{?>
                                        <p class="text-primary h4"><?php echo $p['prix']; ?>DT</p>
                                       <?php }
                                        ?>
