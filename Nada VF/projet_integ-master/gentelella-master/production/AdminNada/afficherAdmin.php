        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <br />
              ...
              <?php
              include_once "C:/wamp64/www/projet_integ-master/gentelella-master/production/Product/headerfinal.php"
              ?>
            <!-- /menu footer buttons -->
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table">
					  ...
					  <?PHP
                      include "C:/wamp64/www/projet_integ-master/core/adminC.php";
$admin1C=new adminC();
