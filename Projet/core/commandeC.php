<?php
include "D:/programs/wamp64/www/Projet/entities/commande.php";
include "D:/programs/wamp64/www/Projet/core/panierC.php";
...
class CommandeC{
 ...
 function ajouterCommande($commande){
		$sql="insert into commandes (cin,prix_t,livraison,payment) values (:cin, :prix_t,:livraison ,:payment)";
