                     ...
                     $totalD=$panier->Total();
                      ...
                      ?>
                            ...
                            <?php if($p['QTE']>=500 && $p['prix']*$p['QTE']>=5000 ){    ?>
                              <td><?php echo ($p['prix']*$p['QTE']-($p['prix']*$p['QTE']*50)/100)/2; ?> DT <p>Remise Special<small> -50%</small></p></td>
                              <?php $total=$total-($p['prix']*$p['QTE']*50)/100/2 ?>
                              <?php $totalF+=$total;
                            ...
                            <?php if($p['QTE']>=500 && $p['prix']*$p['QTE']<5000 ){    ?>
                              <td><?php echo ($p['prix']*$p['QTE']-($p['prix']*$p['QTE']*20)/100)/2; ?> DT<p>Remise Sur Quantite <small> -20%</small></p></td>
                              <?php $total=$total-($p['prix']*$p['QTE']*20)/100/2 ?>
                            ...
                            <?php if($p['QTE']<500 && $p['prix']*$p['QTE']>=5000 ){ ?>
                              <td><?php echo ($p['prix']*$p['QTE']-($p['prix']*$p['QTE']*20)/100)/2; ?> DT<p>Remise sur Prix<small> -20%</small></p></td>
                              <?php $total=$total-($p['prix']*$p['QTE']*20)/100/2 ?>
                              <?php $totalF+=$total;
                            }?>
                            <?php if($p['QTE']<500 && $p['prix']*$p['QTE']<5000 ){    ?>
                              <td><?php echo ($p['prix']*$p['QTE'])/2; ?> DT</td>
                              <?php
                            }?>
                            </tr>
                          <?php
                        ...
                        ?>
                            <tr>
                              ...
                              <?php if($totalF==0){$_SESSION['total']=$totalD; ?>
                                <td class="text-black font-weight-bold"><strong><?php echo $totalD/2;?> DT </td>
                              <?php }else{$_SESSION['total']=$totalF;?>
                               <td class="text-black font-weight-bold"><strong><strike><?php echo $totalD/2;?> DT </strike><br><?php echo $totalF ?></strong> DT</td>
                              <?php }?>
